...
@section('content')
    ...
    @endif
    <h1>Category</h1>
    <p>See all registered categories and their details.</p>
    <div class="StockLinks">
        <a href="{{ route('categories.create') }}"><span style="font-size: 30px">+</span>Add Category</a>
    </div>
    <table>
        <thead>
            <tr>
    ...
    <div style="display:flex; gap:8px; align-items:center;">
        ...
        @else
            <a href="{{ $categories->previousPageUrl() }}" style="opacity:0.5; font-weight:bold; font-size:40px;">←</a>
        @endif
        ...
        @if ($categories->hasMorePages())
            <a href="{{ $categories->nextPageUrl() }}" style="opacity:0.5; font-weight:bold; font-size:40px;">→</a>
        @else
            <span style="opacity:0.5; font-weight:bold; font-size:40px;">→</span>
        @endif
